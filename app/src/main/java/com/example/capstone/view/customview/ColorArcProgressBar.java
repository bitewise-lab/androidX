package com.example.capstone.view.customview;
...
public class ColorArcProgressBar extends View{
    ...
    private String hintColor = "#1A3636";
    private String longDegreeColor = "#EEE7DA";
    private String shortDegreeColor = "#EEE7DA";
    private String bgArcColor = "#EEE7DA";
